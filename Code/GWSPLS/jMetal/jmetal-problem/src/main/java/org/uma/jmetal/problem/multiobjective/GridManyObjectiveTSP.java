...
public class GridManyObjectiveTSP extends AbstractGridIntegerPermutationProblem {
	protected int numberOfCities;
	protected List<double[][]> objectiveMatrics = new ArrayList<double[][]>();

	public GridManyObjectiveTSP(String[] tspPaths) throws IOException {
	...
	/**
	 * redefine the name of this problem
	 */
