...
public class EpsilonTSPExperiment2 {
...
//		int i = 0;
				for (int run = 0; run < 30; run++) {
					...
					ManyObjectiveTSP problem = (ManyObjectiveTSP) ProblemFactory.getTSP(problemName[i], 100, 2);
					NeighborSearchOperator<PermutationSolution<Integer>> operator = OperatorFactory.getOperator(0.3,
							problem);
